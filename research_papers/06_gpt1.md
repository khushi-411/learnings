...
- Learning from unsupervised learning can provide a boost. Eg, the use of word embeddings in pre-trained tasks.
...
3. **Semantic Similarity**
    ...
    - Datasets used were Microsoft Paraphrase corpus, Quora Question Pairs, and Semantic Textual similarity benchmark.
4. **Classification**
...
- The paper suggests significant improvement are possible in future.
