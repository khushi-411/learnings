...
#### Setup
1. **Unsupervised pre-training**
    - BooksCorpus and Word benchmark datasets for traning.
...
2. **Model specifications**
    ...
    - Used learned position embeddings instead of sinusoidal version.
...
3. **Fine-tuning details**
    - Reuse the hyperparameter setttings from unsupervised pre-training.
    - Dropout rate = $0.1$
...
1. **Natural Language Inference (NLI)**
    - This tasks involves reading a pair of sentences and judging the relationship between them.
    - This is a challenging tasks which involves vauge tasks.
    - Datasets used for evaluation image captions, translated speech, popular fiction, government reports, Wikipedia articles, science exams or news articles.
2. **Question answering and commonsense reasoning**
    - Requires aspects of single and multi-sentence resoning.
    - RACE and Story Cloze Datasets is used.
    - This demonstrates the models ability to use long-range contexts effectively.
3. **Semantic Similarity**
    - Involves whether the two statements are equvalent or not.
    - Datasets used were Microsoft Paraphrase corpus, Quora Question Pairs, Semantic Textual similarity benchmark.
4. **Classification**
    - Evaluate text classification tasks.
    - Datasets used were CoLA, SST-2.
