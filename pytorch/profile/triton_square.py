# Ref: https://github.com/cuda-mode/profiling-cuda-in-torch/blob/main/triton_square.py
...
# If you want to use Triton debugger:
...
def square(x):
    ...
    # increasing the number of warps (`num_wraps`) over which each row is distributed.
